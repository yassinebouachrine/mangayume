...
GENRES = [
    ('Action', 'action'), ('Aventure', 'adventure'), ('Comédie', 'comedy'),
    ('Drame', 'drama'), ('Fantasy', 'fantasy'), ('Horreur', 'horror'),
    ('Mystère', 'mystery'), ('Psychologique', 'psychological'),
    ('Romance', 'romance'), ('Sci-Fi', 'sci-fi'),
    ('Tranche de vie', 'slice-of-life'), ('Sports', 'sports'),
    ('Surnaturel', 'supernatural'), ('Thriller', 'thriller'),
    ('Historique', 'historical'), ('Mecha', 'mecha'),
    ('École', 'school'), ('Shōnen', 'shounen'), ('Shōjo', 'shoujo'),
    ('Seinen', 'seinen'), ('Josei', 'josei'), ('Isekai', 'isekai'),
    ('Harem', 'harem'), ('Arts Martiaux', 'martial-arts'),
    ('Militaire', 'military'), ('Super Pouvoir', 'super-power'),
    ('Vampire', 'vampire'), ('Démons', 'demons'), ('Magie', 'magic'),
    ('Tragédie', 'tragedy'), ('Réincarnation', 'reincarnation')
]
